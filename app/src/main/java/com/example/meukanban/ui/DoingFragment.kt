...
import com.example.meukanban.databinding.FragmentDoingBinding
...
class DoingFragment : Fragment() {
    ...
    private fun refreshTasks() {
        taskAdapter.submitList(TaskRepository.getByStatus(Status.DOING))
    }
